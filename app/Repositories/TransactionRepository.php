...
class TransactionRepository implements TransactionRepositoryInterface
{
    ...
    {
        return 'TRX' . rand(1000000, 9999999);
    }
    ...
    public function getTransactionByCodeEmailPhone($code, $email, $phoneNumber)
    {
        return Transaction::where('code', $code)->where('email', $email)->where('phone_number', $phoneNumber)->first();
    }
}