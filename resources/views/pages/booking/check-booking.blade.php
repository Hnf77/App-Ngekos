...
@section('content')
    ...
    <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
        ...
        <form action="{{ route('pages.booking.check-booking.show') }}"
            ...
            <div id="InputContainer" class="flex flex-col gap-[18px]">
                <div class="flex flex-col w-full gap-2">
                    ...
                    @error('code')
                        <p class="text-sm" style="color: rgb(252, 35, 35)">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col w-full gap-2">
                ...
                @if (session('error'))
                    <p class="text-center" style="color: rgb(252, 35, 35)">{{ session('error') }}</p>
                @endif
