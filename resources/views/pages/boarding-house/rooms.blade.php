...
@section('content')
    ...
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        <a href="{{ route('pages.boarding-house.show', $boardingHouse->slug) }}"
    ...
    <form action="{{ route('pages.booking.index', $boardingHouse->slug) }}" class="relative flex flex-col gap-4 mt-5">
